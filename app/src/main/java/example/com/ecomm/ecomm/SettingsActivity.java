...
public class SettingsActivity extends AppCompatActivity {
    ...
    private EditText userNameEditText, userPhoneEditText, addressEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userInfoDisplay(profileImageView, userNameEditText, userPhoneEditText, addressEditText);
    ...
    private void userInfoDisplay(final CircleImageView profileImageView, final EditText userNameEditText, final EditText userPhoneEditText, final EditText addressEditText)
    {
