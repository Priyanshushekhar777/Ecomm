...
import example.com.ecomm.ecomm.Model.Products;
import example.com.ecomm.ecomm.Prevalent.Prevalent;
import example.com.ecomm.ecomm.ViewHolder.ProductViewHolder;
        ...
        implements NavigationView.OnNavigationItemSelectedListener
{
        ...
        FirebaseRecyclerAdapter<Products, ProductViewHolder> adapter =
                new FirebaseRecyclerAdapter<Products, ProductViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull Products model)
                    {
                      ...
                      holder.getTxtProductPrice.setText(model.getPrice());
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        else if (id == R.id.nav_caregories)
        {
